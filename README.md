...
### TL;DR: Need a powerful category/instance-level pose estimation method using only CAD models? CPPF++ is your solution. No real pose annotations, no complex synthetic renderings, no fancy augmentations; just CAD models and a probabilistic voting-based pipeline that works.
